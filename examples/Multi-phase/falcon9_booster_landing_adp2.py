...
xf = np.array([r0[0], r0[1], r0[2], 0, 0, 0, 1e3])
q_max = 80 * 1e3
...
seg, p, max_iter = 8, 4, 2
# seg, p, max_iter = 3, 11, 2
...
mpo._THRESHOLD_SLOPE = 0.5
# mpo = mp.mpopt_adaptive(ocp, seg, p)
mpo._INTERPOLATION_NODES_PER_SEG = 10
